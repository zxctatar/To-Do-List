...
#include "../../../src/startWindow/widgets/TaskWidget/model/taskmodel.h"
...
constexpr auto qt_meta_stringdata_CLASSTaskModelENDCLASS = QtMocHelpers::stringData(
    "TaskModel",
    "loadDone",
    "",
    "QList<Task>&",
...
void TaskModel::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (TaskModel::*)(QList<Task> & );
            if (_t _q_method = &TaskModel::loadDone; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void TaskModel::loadDone(QList<Task> & _t1)
{
