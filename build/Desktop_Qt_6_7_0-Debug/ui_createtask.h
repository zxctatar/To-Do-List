...
public:
    ...
    void setupUi(QWidget *CreateTask)
    {
        ...
        CreateTask->setStyleSheet(QString::fromUtf8("QWidget\n"
"{\n"
...
"}"));
        ...
        pushButton_done->setStyleSheet(QString::fromUtf8("color: rgb(0, 0, 0);"));

        horizontalLayout->addWidget(pushButton_done, 0, Qt::AlignHCenter);
